...
builder.Services.AddHttpClient(nameof(InvocationDeliveryService));
builder.Services.AddSingleton<InvocationDeliveryService>();
builder.Services.AddHostedService(serviceProvider => serviceProvider.GetRequiredService<InvocationDeliveryService>());
